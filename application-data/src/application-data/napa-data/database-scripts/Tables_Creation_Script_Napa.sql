DROP SCHEMA IF EXISTS INTEL_SMART_ANTENNA_DATA_STORE_NAPA;
CREATE SCHEMA INTEL_SMART_ANTENNA_DATA_STORE_NAPA;
USE INTEL_SMART_ANTENNA_DATA_STORE_NAPA;
DROP TABLE IF EXISTS CLOTHGROUPING_ACCURACY_RESULT;
...
DROP TABLE IF EXISTS J48_ACCURACY_RESULT;
...
DROP TABLE IF EXISTS J48_RESULT;
...
DROP TABLE IF EXISTS PREDICTION_ACCURACY_RESULT;
...
DROP TABLE IF EXISTS RANDOM_FOREST_BINARY_ACCURACY_RESULT;
...
DROP TABLE IF EXISTS RANDOM_FOREST_BINARY_RESULT;
...
DROP TABLE IF EXISTS SUB_QUADRANT_WISE_PREDICTION_RESULT;
...
DROP TABLE IF EXISTS TAGREADEVENTS;
...
DROP TABLE IF EXISTS VOTING_ACCURACY_RESULT;
...
DROP TABLE IF EXISTS REFERENCE_TABLE_NAPA;
CREATE TABLE `REFERENCE_TABLE_NAPA` (
  `EPC` varchar(45) NOT NULL,
